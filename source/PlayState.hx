...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Tá jogando o que sabe', 0.2], //From 0% to 19%
		['Vacilou legal', 0.4], //From 20% to 39%
		['Moscou', 0.5], //From 40% to 49%
		['Noobou', 0.6], //From 50% to 59%
		['É mais ou menos...', 0.69], //From 60% to 68%
		['SEXOOOO', 0.7], //69%
		['Brabo', 0.8], //From 70% to 79%
		['Foda Massa Legal', 0.9], //From 80% to 89%
		['Manja', 1], //From 90% to 99%
		['O Fodão tem nome!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
